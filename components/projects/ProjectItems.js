...
const ProjectItems = ({project}) => {
  return (
    <div className='bg-[#fff] border-[1px] border-solid border-[rgba(0,0,0,0.1)] p-4 lg:p-5 rounded-2xl' key={project.id}>
      ...
      <a href='#' className="group text-[#757575] text-sm flex items-center gap-x-1">
