  ...
  return (
    <footer className='footer bg-containerColor border-t-[1px] border-solid border-[rgba(0,0,0,0.1)]'>
      <div className="footerContainer pt-8 pb-24 sectionContainer">
        <h1 className='footerTitle text-titleColor text-3xl text-center mb-8'>Jay</h1>
        ...
        <span className="footerCopy block mt-16 text-titleColor text-center text-sm">&#169;2023. Made by Jay Panchal</span>
      </div>
    </footer>
  )
}
